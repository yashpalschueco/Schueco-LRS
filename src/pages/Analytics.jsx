    ...
    <div className="p-4 sm:p-8 max-w-6xl">
      ...
      {tab === 'overview' && (
        <>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
            ...
            <SummaryCard label="Total Pipeline" value={fmtCr(totalPipeline)} color="#C9A44A" sub={`${filteredInquiries.filter(i=>i.status==='Ongoing').length} ongoing`} />
      ...
      {tab === 'fabricators' && (
        <>
          ...
          <div className="bg-white border border-gray-200 rounded-xl p-4 mb-4">
            <label className="block text-[10px] font-medium tracking-widest text-gray-500 mb-1.5">VIEW DETAILS FOR A SPECIFIC FABRICATOR / PARTNER</label>
      ...
      {tab === 'architects' && (
        <>
          ...
          <div className="bg-white border border-gray-200 rounded-xl p-4 mb-4">
            <label className="block text-[10px] font-medium tracking-widest text-gray-500 mb-1.5">VIEW DETAILS FOR A SPECIFIC ARCHITECT</label>
      ...
      {tab === 'team' && (
        <>
          <div className="bg-white border border-gray-200 rounded-xl p-4 mb-4">
            <label className="block text-[10px] font-medium tracking-widest text-gray-500 mb-1.5">VIEW DETAILS FOR A TEAM MEMBER</label>
        ...
        <div className="bg-white border border-gray-200 rounded-xl overflow-hidden">
          ...
          <div className="divide-y divide-gray-50 max-h-[36rem] overflow-y-auto">
            {staleInquiries.length === 0 ? (
              ...
              <div key={i.id} className="px-4 sm:px-5 py-3.5 flex flex-col sm:flex-row sm:items-center justify-between gap-2 sm:gap-3">
                <div className="min-w-0">
        ...
        <>
          <div className="bg-white border border-gray-200 rounded-xl p-4 mb-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                <label className="block text-[10px] font-medium tracking-widest text-gray-500 mb-1.5">FIRST {compareType.toUpperCase()}</label>
              ...
              <div>
                <label className="block text-[10px] font-medium tracking-widest text-gray-500 mb-1.5">SECOND {compareType.toUpperCase()}</label>
